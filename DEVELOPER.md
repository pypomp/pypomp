...
Coverage spans two model families deliberately: the linear-Gaussian fixtures exercise the common path, and `test_sir_regression.py` covers the accumulator reset, discrete measurement density, and non-trivial parameter transform that LG does not.
