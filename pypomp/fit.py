...
def fit(pomp_object=None, J=100, Jh=1000, theta=None, rinit=None, rprocess=None, dmeasure=None, 
    ...
    Args:
        ...
        method (str, optional): The gradient optimization method to use, including Newton method,
                                weighted Newton method BFGS method, gradient descent. 
                                Defaults to 'Newton'.
        ...
        thresh_mif (float, optional): Threshold value to determine whether to resample particles 
        ...
        verbose (bool, optional): Boolean flag controlling whether to print out the log-likelihood
                                  and parameter information. Defaults to False.
    ...
    Raises:
        ValueError: Missing the required arguments 'sigmas' or 'sigmas_init' in 'IF2' or 'IFAD'
                    when executing on the pomp class object
        ValueError: Invalid mode input when executing on the pomp class object
        ValueError: Missing the required arguments, workhorses, 'sigmas' or 'sigmas_init' in 
                    'IF2' or 'IFAD' when calling the function 'fit_internal' directly.
