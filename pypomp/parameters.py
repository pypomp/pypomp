...
class PompParameters(ParameterSet):
    ...
    def __init__(self, theta: Union[dict, list[dict], "PompParameters"]):
        """
        Args:
        ...
        self.estimation_scale: bool = False
    ...
    def subset(self, indices: Union[int, list[int], slice]) -> "PompParameters":
        ...
        return PompParameters(subset_params)
    ...
    def __getitem__(self, index: Union[int, slice]) -> Union[dict, "PompParameters"]:
        """
        Support indexing like theta[0] or theta[0:2].
        """
        return PompParameters(self._params[index])
    ...
    def __mul__(self, n: int) -> "PompParameters":
        ...
        return PompParameters(replicated_params)
