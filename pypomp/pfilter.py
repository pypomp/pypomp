...
def pfilter(pomp_object=None, J=50, rinit=None, rprocess=None, dmeasure=None, theta=None, ys=None, covars=None,
            thresh=100, key=None):
    """
    An outside function for particle filtering algorithm. It receives two kinds of input - pomp class object or 
    required arguments of 'pfilter_internal' function, and executes on the object or calls 'pfilter_internal' directly.
    ...
    Raises:
        ValueError: Missing the pomp class object and required arguments for calling 'pfilter_internal' directly
