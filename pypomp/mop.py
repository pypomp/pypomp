...
def mop(pomp_object=None, J=50, rinit=None, rprocess=None, dmeasure=None, theta=None, ys=None,
        covars=None, alpha=0.97, key=None):
    """
    An outside function for MOP algorithm. It receives two kinds of input - pomp class object
    or the required arguments of 'mop_internal' function, and executes on the object or calls
    'mop_internal' directly.
   
    Args:
        pomp_object (Pomp, optional): An instance of the POMP class. If provided, the function 
                                      will execute on this object to conduct the MOP algorithm. 
                                      Defaults to None.
