...
def test_transform_panel_traces_shared_only():
    ...
    shared_traces = np.array([
        [[np.nan, 2.0, 3.0],   # iter 0: loglik=nan, shared_param1=log(2), shared_param2=log(3)
         [-10.5, 2.5, 3.5]],   # iter 1: loglik=-10.5, shared_param1=log(2.5), shared_param2=log(3.5)
    ])
...
def test_transform_panel_traces_unit_only():
    ...
    unit_traces = np.array([
        [[[np.nan, np.nan],    # iter 0: unit logliks
          [1.0, 1.5]],         # iter 0: unit_param1 for unit1, unit2
         [[-5.0, -6.0],        # iter 1: unit logliks
          [2.0, 2.5]]],        # iter 1: unit_param1 for unit1, unit2
    ])
...
def test_transform_panel_traces_both():
    ...
    unit_traces = np.array([
        [[[np.nan, np.nan],    # iter 0: unit logliks
          [2.0, 2.5]],         # iter 0: unit_param
         [[-5.0, -6.0],        # iter 1: unit logliks
          [3.0, 3.5]]],        # iter 1: unit_param
    ])
