...
def perfilter(
    ...
    """
    An outside function for perturbed particle filtering algorithm. It receives
    two kinds of input - pomp class object or the required arguments of
    'perfilter_internal' function, and executes on the object or calls
    ...
    Args:
        pomp_object (Pomp, optional): An instance of the POMP class. If
            ...
            perturbed particle filtering algorithm. Defaults to None.
        J (int, optional): The number of particles. Defaults to 50.
        rinit (function, optional): Simulator for the initial-state
            distribution. Defaults to None.
        rprocesses (function, optional): Simulator for the process model.
            Defaults to None.
        dmeasures (function, optional): Density evaluation for the measurement
    ...
    Raises:
        ValueError: Missing the pomp class object and required arguments for
            calling 'perfilter_internal' directly
