...
class TestPompClass_LG(unittest.TestCase):
    ...
    def test_mop_invalid(self):
        ...
        #useless args
        with self.assertRaises(TypeError):
            pomp_obj.mop(self.theta, self.ys, self.J, self.rinit, self.rprocess, self.dmeasure, self.covars, alpha = 0.97, key = self.key)
        ...
        #useless args
        with self.assertRaises(TypeError):
            pomp_obj.mop_mean(self.theta, self.ys, self.J, self.rinit, self.rprocess, self.dmeasure, self.covars, alpha = 0.97, key = self.key)
    ...
    def test_pfilter_invalid(self):
        ...
        #useless args
        with self.assertRaises(TypeError):
            pomp_obj.pfilter(self.theta, self.ys, self.J, self.rinit, self.rprocess, self.dmeasure, self.covars,  key = self.key)
        ...
        #useless args
        with self.assertRaises(TypeError):
            pomp_obj.pfilter_mean(self.theta, self.ys, self.J, self.rinit, self.rprocess, self.dmeasure, self.covars,  key = self.key)
    ...
    def test_perfilter_invalid(self):
        ...
        with self.assertRaises(TypeError):
            pomp_obj.perfilter(self.theta, self.ys, self.J, sigmas = 0.02, rinit = self.rinit, rprocess = self.rprocess, dmeasure = self.dmeasure, covars = self.covars,  key = self.key)

        with self.assertRaises(TypeError):
            pomp_obj.perfilter(self.J, sigmas = 0.02, rinit = self.rinit, rprocess = self.rprocess, dmeasure = self.dmeasure, key = self.key)
        ...
        with self.assertRaises(TypeError):
            pomp_obj.perfilter_mean(self.theta, self.ys, self.J, sigmas = 0.02, rinit = self.rinit, rprocess = self.rprocess, dmeasure = self.dmeasure, covars = self.covars,  key = self.key)

        with self.assertRaises(TypeError):
            pomp_obj.perfilter_mean(self.J, sigmas = 0.02, rinit = self.rinit, rprocess = self.rprocess, dmeasure = self.dmeasure, key = self.key)
    ...
    def test_pfilter_pf_invalid(self):
        ...
        with self.assertRaises(TypeError):
            pomp_obj.pfilter_pf(self.theta, self.ys, self.J, rinit = self.rinit, rprocess = self.rprocess, dmeasure = self.dmeasure, covars = self.covars,  key = self.key)
    ...
    def test_fit_mif_valid(self):
        ...
        mif_loglik2, mif_theta2 = pomp_obj.fit(sigmas = 0.02, sigmas_init = 1e-20, M = 2, a = 0.9, J = self.J,  mode = "IF2", monitor = False)
    ...
    def test_fit_mif_invalid(self):
        ...
        #useless input
        with self.assertRaises(TypeError):
            pomp_obj.fit(rinit = self.rinit, rprocess = self.rprocess, dmeasure = self.dmeasure, rprocesses = self.rprocesses, dmeasures = self.dmeasures, sigmas = 0.02, sigmas_init = 1e-20, mode = "IF2")
    ...
    def test_fit_GD_valid(self):
        ...
        GD_loglik2, GD_theta2 = pomp_obj.fit(J = 10, Jh= 10, method = "SGD", itns = 2, alpha = 0.97, scale = True, ls = True, mode = "GD")
        ...
        GD_loglik4, GD_theta4 = pomp_obj.fit(J = 10, Jh= 10, method = "Newton", itns = 2, alpha = 0.97, scale = True, ls = True, mode = "GD")
        ...
        #refined Newton
        GD_loglik5, GD_theta5 = pomp_obj.fit(J = 10, Jh= 10, method = "WeightedNewton", itns = 2, alpha = 0.97, scale = True, mode = "GD")
        ...
        GD_loglik6, GD_theta6 = pomp_obj.fit(J = 10, Jh= 10, method = "WeightedNewton", itns = 2, alpha = 0.97, scale = True, ls = True, mode = "GD")
        ...
        GD_loglik8, GD_theta8 = pomp_obj.fit(J = 10, Jh= 10, method = "BFGS", itns = 2, alpha = 0.97, scale = True, ls = True, mode = "GD")
    ...
    def test_fit_GD_invalid(self):
        ...
        #useless input
        with self.assertRaises(TypeError):
            pomp_obj.fit(self.theta, self.ys, self.rinit, self.rprocess, self.dmeasure,  J = 10, Jh = 10, method = "BFGS", itns = 2, alpha = 0.97, scale = True, mode = "GD")
        
    def test_fit_IFAD_valid(self):
        pomp_obj = Pomp(custom_rinit, custom_rproc, custom_dmeas, self.ys, self.theta)
        IFAD_loglik1, IFAD_theta1 = pomp_obj.fit(sigmas = 0.02, sigmas_init = 1e-20, M = 2,J = 10, Jh= 10, method = "SGD", itns = 2, alpha = 0.97, scale = True, mode = "IFAD")
        ...
        IFAD_loglik2, IFAD_theta2 = pomp_obj.fit(sigmas = 0.02, sigmas_init = 1e-20, M = 2, J = 10, Jh= 10, method = "Newton", itns = 2, alpha = 0.97, scale = True, ls = True, mode = "IFAD")
        ...
        IFAD_loglik3, IFAD_theta3 = pomp_obj.fit(sigmas = 0.02, sigmas_init = 1e-20, M = 2, J = 10, Jh= 10, method = "WeightedNewton", itns = 2, alpha = 0.97, scale = True, mode = "IFAD")
        ...
        IFAD_loglik4, IFAD_theta4 = pomp_obj.fit(sigmas = 0.02, sigmas_init = 1e-20, M =2, J = 10, Jh= 10, method = "BFGS", itns = 2, alpha = 0.97, scale = True, mode = "IFAD")
    ...
    def test_fit_IFAD_invalid(self):
        ...
        #useless input
        with self.assertRaises(TypeError):
            pomp_obj.fit(self.theta, self.ys, self.rinit, self.rprocess, self.dmeasure, self.rprocesses, self.dmeasures, sigmas = 0.02, sigmas_init = 1e-20, M = 2,J = 10, Jh= 10, method = "SGD", itns = 2, alpha = 0.97, scale = True, mode = "IFAD")
